export const de = {
  ...
  investments: {
    header: "Investitionen",
    sectionOne: {
      header: "Fortgeschrittene Projekte",
      paragraphOne:
        "Wir sind auf strategische Immobilieninvestitionen spezialisiert. Wir realisieren Projekte mit hohem Renditepotenzial, sowohl im Wohn- als auch im Gewerbesektor.",
      paragraphTwo:
        "Unsere Investitionen werden sorgfältig geplant und umgesetzt, um den Wert für unsere Kunden und Partner zu maximieren. Jedes Projekt wird hinsichtlich Rentabilität, Standort und Wachstumspotenzial analysiert.",
    },
    sectionTwo: {
      header: "Innovative Lösungen",
      paragraphOne:
        "Wir implementieren innovative Investitionslösungen, die auf die sich ändernden Marktanforderungen reagieren. Unsere Projekte basieren auf den neuesten Trends und Technologien in der Immobilienbranche.",
      paragraphTwo:
        "Dank der Erfahrung und des Wissens unseres Teams sind wir in der Lage, Investitionen anzubieten, die nicht nur die Erwartungen unserer Kunden erfüllen, sondern auch neue Maßstäbe in der Branche setzen.",
    },
  },
  ...
  offers: {
    ...
    defaultOffersCardsName: {
      ...
      premises: "Räumlichkeit zur Miete",
      plots: "Grundstück zum Verkauf",
    },

    detailedDescriptions: {
      headers: {
        characteristics: "Charakteristik",
        consultant: "Kontaktperson",
      ...
      characteristicsValues: {
        buildingType: {
          tenement: "Mietshaus",
          block: "Block",
          "multi-unit building": "Mehrzweckgebäude",
        },
        feesIncludedInRent: {
      ...
      realEstateSpecificDescriptionsByFamilyAndId: {
        apartments: {
          ...
          1: {
            ...
            amenities: [
              { name: "Fitnessstudio", icon: "gym" },
              { name: "Aufzug", icon: "elevator" },
              { name: "Vollmöblierung", icon: "furniture" },
              { name: "Glasfaserinternet", icon: "wifi" },
              { name: "Bose Sound System", icon: "sound-system" },
              { name: "Klimaanlage", icon: "air-conditioning" },
              { name: "Fußbodenheizung", icon: "underfloor-heating" },
              { name: "Badewanne", icon: "bathtub" },
              { name: "Dusche", icon: "shower" },
              { name: "Kleiderbügel", icon: "hanger" },
              { name: "Außenfensterjalousien", icon: "window-blinds" },
              { name: "TV + Netflix", icon: "tv" },
              { name: "Kühlschrank", icon: "fridge" },
              { name: "Geschirrspüler", icon: "dishwasher" },
              { name: "Mikrowelle", icon: "microwave" },
              { name: "Kaffeemaschine", icon: "coffee-machine" },
              { name: "Backofen", icon: "oven" },
              { name: "Kochfeld", icon: "cooktop" },
              { name: "Waschmaschine", icon: "washing-machine" },
              { name: "Kleiderbügel / Trockner", icon: "clothes-dryer" },
              { name: "Innenüberwachung", icon: "security-camera" },
              { name: "Außenüberwachung", icon: "security-camera-exterior" },
              { name: "Einbruchalarm", icon: "security-alarm" },
              { name: "Oberlicht", icon: "skylight" },
            ],
          },
          ...
          2: {
            ...
            amenities: [
              { name: "Aufzug", icon: "elevator" },
              {
                name: "Vollmöblierung (Schreibtische, Schränke, Stühle, Sofa)",
                icon: "furniture",
              },
              { name: "Glasfaserinternet", icon: "wifi" },
              { name: "Sound System (Heimkino)", icon: "home-theater" },
              { name: "Fußbodenheizung", icon: "underfloor-heating" },
              { name: "Badewanne", icon: "bathtub" },
              { name: "Dusche", icon: "shower" },
              { name: "Garderobe für Kleidung", icon: "closet" },
              { name: "Außenfensterjalousien", icon: "window-blinds" },
              { name: "TV", icon: "tv" },
              {
                name: "Kühlschrank (mit Eiswürfelfunktion und Gefrierfach)",
                icon: "fridge",
              },
              { name: "Geschirrspüler", icon: "dishwasher" },
              { name: "Mikrowelle", icon: "microwave" },
              ...
              { name: "Kleiderbügel / Trockner", icon: "clothes-dryer" },
              { name: "Außenüberwachung", icon: "security-camera-exterior" },
              { name: "Oberlichter (Zwei)", icon: "skylight" },
            ],
          },
        },
